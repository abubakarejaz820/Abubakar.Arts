...
export const Hero = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-white dark:bg-zinc-950 pt-16 sm:pt-24 lg:pt-32">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col lg:flex-row items-center lg:items-start lg:justify-between space-y-12 lg:space-y-0 lg:space-x-16">
          ...
          >
            <h1 className="text-3xl sm:text-5xl lg:text-7xl font-extrabold tracking-tight text-gray-900 dark:text-white leading-tight">
              <span className="block text-amber-500">Exquisite Islamic</span>{' '}
              <span className="block">Calligraphy Art</span>
            </h1>
            <p className="mt-6 max-w-xl mx-auto lg:mx-0 text-base sm:text-xl text-gray-600 dark:text-gray-300">
            ...
            <div className="mt-8 flex flex-col sm:flex-row justify-center lg:justify-start gap-3 sm:gap-4">
              <a
                href="#catalog"
                className="inline-block px-6 sm:px-10 py-3 sm:py-4 text-sm sm:text-base font-semibold rounded-full text-white bg-amber-600 hover:bg-amber-700 shadow-xl transform transition-transform duration-300 hover:scale-105"
              >
                Explore Collection
              </a>
              <a
                href="#contact"
                className="inline-block px-6 sm:px-10 py-3 sm:py-4 border-2 border-amber-600 text-sm sm:text-base font-semibold rounded-full text-amber-700 bg-white hover:bg-amber-50 transition duration-300 dark:bg-zinc-900 dark:text-amber-500 dark:hover:bg-zinc-800"
              >
                Contact Us
              </a>
            </div>
