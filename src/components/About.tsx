...
export const About = (): ReactElement => {
  return (
    <section
      id="about"
      className="relative overflow-hidden py-16 sm:py-24 lg:py-32 bg-gradient-to-br from-white via-amber-50 to-zinc-100 dark:from-zinc-950 dark:via-zinc-900 dark:to-amber-900"
    >
      {/* Animated Blobs */}
      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-12">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16">
          <h2 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold text-gray-900 dark:text-white tracking-tight drop-shadow-lg">
            About <span className="text-amber-500">Abubakar.Arts</span>
          </h2>
          <p className="mt-4 text-base sm:text-xl text-gray-600 dark:text-gray-300 font-medium drop-shadow">
            Blending tradition with a modern touch to create art that speaks to the soul.
          </p>
        </div>

        {/* Mission & Image Section */}
        <div className="mt-12 sm:mt-16 grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 items-center">
          {/* Image */}
          ...
          <div className="md:order-1">
            <h3 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white tracking-wide mb-4 drop-shadow-lg">
              Our Mission
            </h3>
        ...
        {/* Artist Section */}
        <div className="mt-16 sm:mt-24 max-w-3xl mx-auto text-center bg-white/80 dark:bg-zinc-900/80 backdrop-blur-lg rounded-3xl shadow-xl py-8 sm:py-12 px-4 sm:px-6 border border-amber-200 dark:border-amber-800">
          <h3 className="text-2xl sm:text-4xl font-bold text-gray-900 dark:text-white tracking-wide mb-4 drop-shadow-lg">
